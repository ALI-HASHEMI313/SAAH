...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/Sorry');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/SayedAliAbbas.Hashemi313');time.sleep(1)
		admin()
	if bal =='3':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/HASHEMIok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
